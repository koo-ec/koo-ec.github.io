---
description: Selected publications by Dr Koorosh Aslansefat.
---

# Publications

Selected publications are listed below. A full and frequently updated list is available on [Google Scholar](https://scholar.google.com/citations?user=YBa4Tl8AAAAJ).
...
**[When Words Move Markets: Interpretable Behavioural and Robustness Analysis of LLMs for Financial Sentiment Reasoning via Local Perturbation Explanations](https://doi.org/10.1007/978-3-032-29532-3_19)**<br>
Sania Verma, **Koorosh Aslansefat**, Joyjit Chatterjee, Akash Marar, Anu Mehra, Aisha Ekundayo<br>
*Lecture notes in computer science, 2026.* [DOI / source](https://doi.org/10.1007/978-3-032-29532-3_19)

**[Bayesian Uncertainty Propagation for Agentic RAG Pipelines: A Proof-of-Concept Study on Multi-Hop Question Answering](https://doi.org/10.48550/arxiv.2607.00972)**<br>
Louis Donaldson, Connor Walker, **Koorosh Aslansefat**, Yiannis Papadopoulos<br>
*arXiv (Cornell University), 2026.* [DOI / source](https://doi.org/10.48550/arxiv.2607.00972)

**[Risk Assessments for Evasive Emergency Maneuvers in Autonomous Vehicles](https://doi.org/10.48550/arxiv.2604.26050)**<br>
Aliasghar Arab, Milad Khaleghi, **Koorosh Aslansefat**<br>
...
_Automatically updated from [OpenAlex](https://openalex.org/authors/A5008347336) using ORCID [0000-0001-9318-8177](https://orcid.org/0000-0001-9318-8177). Google Scholar remains available as the public profile: [Koorosh Aslansefat](https://scholar.google.com/citations?user=YBa4Tl8AAAAJ&hl=en)._
<!-- AUTO_PUBLICATIONS_LIST_END -->
...
Walker, C., Rothon, C., **Aslansefat, K.**, Papadopoulos, Y., and Dethlefs, N.  
*IOP Journal of Physics*, 2875(1), 1-19, 2024.

**Measuring AI Fairness in a Continuum Maintaining Nuances**  
Paxton, K., **Aslansefat, K.**, Thakker, D., and Papadopoulos, Y.  
*IEEE Internet Computing*, 28(5), 11-19, 2024.

**Explaining black boxes with a SMILE**  
**Aslansefat, K.**, Hashemian, M., Walker, M., Akram, M. N., Sorokos, I., and Papadopoulos, Y.  
*IEEE Software*, 41(1), 87-97, 2023.

**A Review of the Applications of Explainable Machine Learning for Lithium-Ion Batteries**  
Faraji Niri, M., **Aslansefat, K.**, Haghi, S., Hashemian, M., Daub, R., and Marco, J.  
*Energies*, 16(17), 6360, 2023.

**Toward improving confidence in autonomous vehicle software**  
**Aslansefat, K.**, Kabir, S., Abdullatif, A., Vasudevan, V., and Papadopoulos, Y.  
*IEEE Computer*, 54(8), 66-76, 2021.

**SafeDrones: Real-Time Reliability Evaluation of UAVs**  
**Aslansefat, K.**, Nikolaou, P., Walker, M., et al.  
*International Symposium on Model-Based Safety and Assessment*, Springer, 2022.

**SafeML: Safety Monitoring of Machine Learning Classifiers**  
**Aslansefat, K.**, Sorokos, I., Whiting, D., et al.  
*International Symposium on Model-Based Safety and Assessment*, Springer LNCS 12297, 2020.

</div>

## Profiles

- [Google Scholar](https://scholar.google.com/citations?user=YBa4Tl8AAAAJ)
- [ORCID: 0000-0001-9318-8177](https://orcid.org/0000-0001-9318-8177)
- [GitHub](https://github.com/koo-ec)
